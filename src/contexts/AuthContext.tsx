...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  // Função para adicionar logs de autenticação - memoizada
  const addAuthLog = useCallback((level: 'info' | 'warning' | 'error', action: string, details: string) => {
    const logEntry = {
  ...
  const value = useMemo(() => ({
    ...
    isLoading
  }), [user, login, logout, updateUserProfile, isLoading])
